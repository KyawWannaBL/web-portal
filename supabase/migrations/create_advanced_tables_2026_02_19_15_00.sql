-- Create Advanced Features Tables (without conflicts)
...
DROP POLICY IF EXISTS "Allow all operations" ON qr_codes_advanced_2026_02_19_15_00;
CREATE POLICY "Allow all operations" ON qr_codes_advanced_2026_02_19_15_00 FOR ALL USING (true);

DROP POLICY IF EXISTS "Allow all operations" ON gps_tracking_advanced_2026_02_19_15_00;
CREATE POLICY "Allow all operations" ON gps_tracking_advanced_2026_02_19_15_00 FOR ALL USING (true);

DROP POLICY IF EXISTS "Allow all operations" ON electronic_signatures_2026_02_19_15_00;
CREATE POLICY "Allow all operations" ON electronic_signatures_2026_02_19_15_00 FOR ALL USING (true);

DROP POLICY IF EXISTS "Allow all operations" ON route_optimizations_2026_02_19_15_00;
CREATE POLICY "Allow all operations" ON route_optimizations_2026_02_19_15_00 FOR ALL USING (true);

DROP POLICY IF EXISTS "Allow all operations" ON geofences_2026_02_19_15_00;
CREATE POLICY "Allow all operations" ON geofences_2026_02_19_15_00 FOR ALL USING (true);

DROP POLICY IF EXISTS "Allow all operations" ON realtime_events_2026_02_19_15_00;
