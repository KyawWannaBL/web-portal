...
-- QR Codes, GPS Tracking, Electronic Signatures, Routes, Geofences
...
UNION ALL
SELECT 
  'GPS Tracking' as feature,
  COUNT(*) as total_records,
  COUNT(CASE WHEN recorded_at > NOW() - INTERVAL '1 hour' THEN 1 END) as recent_records
