...
export default function SystemTariffs() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center text-slate-500 font-mono animate-in fade-in duration-500">
      <Settings size={64} className="mb-6 opacity-20 text-emerald-500" />
      <h1 className="text-3xl font-black text-white tracking-widest uppercase mb-2">System Tariffs</h1>
