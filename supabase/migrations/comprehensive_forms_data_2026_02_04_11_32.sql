...
('ADV-2026-001', (SELECT id FROM public.deliverymen_2026_02_04_05_03 LIMIT 1), 50000.00, 'Fuel and maintenance advance', '2026-02-01', '2026-02-15', 'active'),
('ADV-2026-002', (SELECT id FROM public.deliverymen_2026_02_04_05_03 LIMIT 1 OFFSET 1), 30000.00, 'Emergency advance for medical expenses', '2026-02-02', '2026-02-16', 'active');
